...
- ``hospital/time_bounds.py`` to evaluate reasonable bounds for formula φ_b
- ``hospital/analysis_item.py`` to evaluate robustness of φ_a, φ_b on simulated item trajectories
- ``hospital/analysis_robot.py`` to evaluate robustness of φ_c on simulated robot trajectories  
