...
df = pd.read_csv("coordinate/results/centralizedimpprox_GUH73_Nb20_Nm0_A120_R43200m_FP0.0.csv")
...
destination_time["lb"] = np.maximum(destination_time["mean"] - 2.0 * destination_time["std"], 0)
destination_time["ub"] = destination_time["mean"] + 2.0 * destination_time["std"]
...
print("Bounds for formulae written in ./results/dest_time_bounds.pkl")